const playerLives = document.querySelector(".playerLives") as HTMLElement
const monsterLives = document.querySelector(".monsterLives") as HTMLElement
const gameOver = document.querySelector(".gameOver") as HTMLElement
const weaponsList = document.querySelector(".weaponsList") as HTMLElement
const attackBtn = document.querySelector("button") as HTMLElement
const gold = document.querySelector(".gold p") as HTMLElement
const potion = document.querySelector(".potion") as HTMLElement
const startAgain = document.querySelector(".startAgain") as HTMLElement
const livesLeftIndicatorPl = document.querySelectorAll("h2")[0] as HTMLElement
const livesLeftIndicatorMon = document.querySelectorAll("h2")[1] as HTMLElement

let goldUnits: number = 0
let monsterLivesBeginning: number = 100
let playersLivesBeginning : number = 100
...
const sword = document.querySelector(".sword") as HTMLElement
const bow = document.querySelector(".bow") as HTMLElement
const wand = document.querySelector(".wand") as HTMLElement
